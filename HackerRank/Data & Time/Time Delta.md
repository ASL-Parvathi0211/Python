# Time Delta
    When users post an update on social media,such as a URL, image, status update etc., other users in their network are able to view this new post on their news feed. Users can also see exactly 
...
def time_delta(t1, t2):
    ...
    d1 = datetime.strptime(t1, format_str)
    d2 = datetime.strptime(t2, format_str)
